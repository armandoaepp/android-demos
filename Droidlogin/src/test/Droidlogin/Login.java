...
public class Login extends Activity {
    ...
    String IP_Server="192.168.1.36";//IP DE NUESTRO PC
    String URL_connect="http://"+IP_Server+"/android/droidlogin/acces.php";//ruta en donde estan nuestros archivos
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registrar.setOnClickListener(new View.OnClickListener(){
        	...
        	public void onClick(View view){
        		...
        		String url = "http://"+IP_Server+"/android/droidlogin/adduser.html";
		    	...
		    	if (jdata!=null && jdata.length() > 0){
					...
					try {
						json_data = jdata.getJSONObject(0); //leemos el primer segmento en nuestro caso el unico
						 ...
						 otro = json_data.getString("otro");
						 Log.e("loginstatus","logstatus= "+logstatus+" otro:"+otro);//muestro por log que obtuvimos
